const styles = {
    ...
    padding: "sm:px-8 px-6 sm:py-16 py-10",

    heroHeadText: "font-black text-primary dark:text-white lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2",
